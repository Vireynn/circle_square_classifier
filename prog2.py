...
c_test_img = config['test.img.path']['circle_test_image']
s_test_img = config['test.img.path']['square_test_image']
...
# Test image
img = cv2.imread(s_test_img, cv2.IMREAD_GRAYSCALE)  # cv2.imread(c_test_img, cv2.IMREAD_GRAYSCALE)
